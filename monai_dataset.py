...
def create_data_loader(data_dir, batch_size, num_workers=8, test=False):
    # full
    ...
    if not test:
        ...
        test_ds = CacheDataset(data=val_files, transform=test_transform, cache_num=1, cache_rate=1.0, num_workers=num_workers)
        test_loader = ThreadDataLoader(test_ds, num_workers=1, batch_size=1)
        return test_loader
